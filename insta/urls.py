...
from insta.views import HomeView, ArticleDetailView , AddPostView , UpdatePostView , DeletePostView , UserPostView ,LikeView
...
urlpatterns = [
    ...
    path('user_posts/<int:pk>', UserPostView.as_view(), name="user_posts")
